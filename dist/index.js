...
class TFEClient {
    ...
    readWorkspaceID(organization, workspace) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const url = `organizations/${external_querystring_namespaceObject.escape(organization)}/workspaces/${external_querystring_namespaceObject.escape(workspace)}`;
                const resp = yield this._client.get(url);
                return resp.data["data"]["id"];
            }
            catch (err) {
                throw new Error(`Failed to read workspace ${organization}/${workspace}: ${err.message}`);
            }
        });
    }
    readRunStatus(runID) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const url = `runs/${external_querystring_namespaceObject.escape(runID)}`;
                const resp = yield this._client.get(url);
